...
import 'package:localsend_app/provider/network/server/controller/direct_web_controller.dart';
...
class ServerService extends Notifier<ServerState?> {
  ...
  late final _directWebController = DirectWebController(_serverUtils);
  ...
  Future<ServerState?> startServer({
    ...
    _directWebController.installRoutes(router: router);
